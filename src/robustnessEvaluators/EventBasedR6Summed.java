...
public class EventBasedR6Summed extends RobustnessEvaluatorBase {
	...
	// and the sum of alternatives is returned.
...
//	List<HardConstraint> originalFeasConstraints;
	...
	public EventBasedR6Summed(RobustnessManager manager) {
		super(manager);
