...
public class TimeBasedR1 extends RobustnessEvaluatorBase {
	...
	public TimeBasedR1(RobustnessManager manager) {
		super(manager);
	...
	public void evaluateIndividual(Individual indiv) {
		...
		for (int time= 0; time< parameters.numTimeSlots; time++){
			...
			robustnessTime[time]= (Ctime[time] - Utime[time]) / Ctime[time];
