...
public class VNSSingleObjP extends VNS {
	...
	double totalAllowedIterations= 70821864 * 0.1; // benchmarking result for HP is 216 seconds. 
	...
	public VNSSingleObjP(List<ConstraintBase> constr) {
		super(constr);
