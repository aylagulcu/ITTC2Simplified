...
public class MoveSwapNew extends SearcherBase {
	...
	public boolean search() {		
		...
		if (ev2!= parameters.UNUSED_EVENT && !dataHolder.cTFeasList.get(dataHolder.eventCourseId[ev2]).contains(time))
			return false;
