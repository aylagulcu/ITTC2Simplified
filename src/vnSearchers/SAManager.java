...
public class SAManager {
	...
	public void applySAforPenalty(Population pop) {
		Individual ind= pop.individuals[pop.bestPIndIndex];
		penaltyImprover.applySA(ind);
	}

	public void applySAforRobustness(Population pop) {
		Individual ind= pop.individuals[pop.bestRIndIndex];
		robustnessImprover.applySA(ind);
	}

	
	public void applySA(Population pop){
		if (GlobalVars.iterCounterWithNoPenaltyImprovement >= 10){
			if (PopulationParameters.currentIteration - iterPApplied >=10){
				applySAforPenalty(pop);
				iterPApplied= PopulationParameters.currentIteration;
			}
		}
//		if (GlobalVars.iterCounterWithNoRobustnessImprovement >= 10){
//			if (PopulationParameters.currentIteration - iterRApplied >=10){
//				applySAforRobustness(pop);
//				iterRApplied= PopulationParameters.currentIteration;
//			}
//		}
