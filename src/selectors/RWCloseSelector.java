...
public class RWCloseSelector extends SelectorBase {
...
//	p i= fitness i / total fitness
	...
	public Individual[] selectIndividual(Population population) {
		...
		int index2= selectSmallestDistance(index1, population);
	...
	private int selectSmallestDistance(int ind1, Population pop) {
		// Select the event which is the most close from the currently selected individual:
		int minInd; // index of the closest individual
		if (ind1== 0) 
			minInd= 1;
		else
			minInd= 0;
